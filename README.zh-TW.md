...
### v14.1（戰士待命修正）
- 友方 `saber`（`戰士`）在沒有敵人時，會回到 `town_center` 鄰格待命
- 目標是讓閒置戰鬥單位回到基地附近，不會停留在上一場戰鬥結束的位置

### v14（戰鬥前線版本，`Call to Arms / 號角響起`）
...
- `ver14/` 是 v14 戰鬥版本封存快照，代號：`Call to Arms / 號角響起`
